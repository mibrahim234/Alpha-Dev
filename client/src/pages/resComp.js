...
const resComp = () => {
    return (
      ...
      <CardContent className="card1">
        <Typography>
         <h1> Lateefah Jana Vicario </h1>
        </Typography>
        <Typography>
        <h3>Hi, I'm a full stack web developer with senior level experience. <br></br>Interested in a cross-functional software development role, that touches all parts of the stack. Looking for a team of humble and talented people which embrace new technology and encourage autonomy. </h3>
        </Typography>
      </CardContent>
